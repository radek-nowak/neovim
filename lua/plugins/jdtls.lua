        ...
        jdtls = function(_, opts)
          vim.api.nvim_create_autocmd("FileType", {
            ...
            callback = function()
              ...
              local workspace_dir = "/home/radek/.workspace/" .. project_name -- See `:help vim.lsp.start_client` for an overview of the supported `config` options.
              local config = {
                ...
                cmd = {
                  ...
                  "-jar",
                  vim.fn.glob("~/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher.gtk.linux.x86_64_1.2.800.v20231003-1442.jar"),
                  -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
